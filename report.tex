...
% |_|
%
The mass of the percolating/spanning cluster \(M\) should be proportional to some power of the system size \(L\). The non-trivial geometry of the spanning cluster causes the exponent to be different from the dimension of the system, i.e. \(2\) in this project.
